...
Check some basic correlations with a simpler linear model. Some code to wrangle the data is hidden, but available in the Rmd file.
...
alignment ~ geography + cultural + cophenetic:
