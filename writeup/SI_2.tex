...
\title{Supplementary Information 2 for \\ \emph{Cultural influences on word meanings revealed throughlarge-scale semantic alignment:}\\Cross-cultural analyses}
\author{Bill Thompson, Se\'{a}n Roberts \& Gary Lupyan}
\date{}
\maketitle

This document contains the supporting information for \emph{Cultural influences on word meanings revealed throughlarge-scale semantic alignment}.  Most of the contents are compiled R markdown documents, showing the R code for analysing the data. The full repository can be found here:\\
\url{https://github.com/seannyD/ImputeEACulturalDifferences}\\
The contents are as follows. Note that page numbers re-set within each section. \\\\
\toccontents
...
\makeatletter 
\renewcommand{\thefigure}{2.3.\@arabic\c@figure}
\makeatother
